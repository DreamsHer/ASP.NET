...
{
    public class WuDingDanController : Controller
    {
        Models.DaXingShangMaoXiTongEntities myModels = new Models.DaXingShangMaoXiTongEntities();
        // GET: ShangPinJinCang/WuDingDan
        public ActionResult WuDingDan()
        {
            return View();
        }
        ...
        {
            var linq = (from tbQueShengltre in myModels.B_DefaulGoodsList//缺省商品表
                        join tbSelectOrPac in myModels.B_OrderFormPactList on tbQueShengltre.OrderFormPactID equals tbSelectOrPac.OrderFormPactID//合同表
                        ...
                        {
                            DefaulGoodsID = tbQueShengltre.DefaulGoodsID,//缺省商品ID（表）
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult BangDingSelectHeTong(int orderformPactID)
        {
            ...
            var linq = (from tbQueShengltre in myModels.B_DefaulGoodsList//缺省商品表
                        ...
                        join tbJieSuanFangShi in myModels.S_MethodOfSettlingAccountsList on tbSelectOrPac.MethodOfSettlingAccountsID equals tbJieSuanFangShi.MethodOfSettlingAccountsID//结算方式
                        join tbSutall in myModels.B_SupplierList on tbSelectOrPac.SupplierID equals tbSutall.SupplierID//供货商
                        where tbSelectOrPac.OrderFormPactID == orderformPactID
                        select new LY.SelectOrderPact
                        {
                            DefaulGoodsID = tbQueShengltre.DefaulGoodsID,//缺省商品ID（表）
                            OrderFormPactID = tbSelectOrPac.OrderFormPactID,//合同ID
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult SelectShangPinZhu(Vo.BsgridPage bsgridPage, Array JieShouID)
        {
            ...
            for (int i = 0; i < intsZ.Length;)
            {
                ...
                var linq = (from tbSelectGoods in myModels.B_GoodsList
                            ...
                            where tbSelectGoods.GoodsID == goodsIDs
        ...
        public ActionResult ChaXunJinCang(Vo.BsgridPage bsgridPage)
        {
            var linq = (from tbSelctWanrHon in myModels.B_WareHouseList//进仓单
                        ...
                        where tbSelctWanrHon.QuFenLeiXingID == 2 && tbSelctWanrHon.ExamineNot == false && tbSelctWanrHon.CrushRedNot == false
                        select new LY.SelectOrderPact
                        {
        ...
        public ActionResult BangDingJinCang(Vo.BsgridPage bsgridPage, int wareHouseID)
        {
            var linq = (from tbSelctWanrHon in myModels.B_WareHouseList//进仓单
                        ...
                        join tbGongHuoShang in myModels.B_SupplierList on tbHeTong.SupplierID equals tbGongHuoShang.SupplierID//供货商
                        join tbJieSuan in myModels.S_MethodOfSettlingAccountsList on tbHeTong.MethodOfSettlingAccountsID equals tbJieSuan.MethodOfSettlingAccountsID//结算方式
                        where tbSelctWanrHon.QuFenLeiXingID == 2 && tbSelctWanrHon.ExamineNot == false && tbSelctWanrHon.CrushRedNot == false && tbSelctWanrHon.WareHouseID == wareHouseID
                        select new LY.SelectOrderPact
                        {
                            WareHouseID = tbSelctWanrHon.WareHouseID,//进仓单
                            Remember = tbSelctWanrHon.Remember,//记录编号
        ...
        public ActionResult SelectShangPinZhuf(Vo.BsgridPage bsgridPage, int WareHousefID1)
        {
            var linq = (from tbSelectWanHtsList in myModels.B_WareHouseList//进仓单ID
                        ...
                        where tbSelectWanHtsList.ExamineNot == false && tbWanHofDeaill.WareHouseID == WareHousefID1//根据进仓明细中的“进仓ID”
                        select new LY.WareHouseDeitaLL
                        {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult DeleteWareHert(int WarHouserid)
        {
            string strMsg = "fail";
            try
            {
