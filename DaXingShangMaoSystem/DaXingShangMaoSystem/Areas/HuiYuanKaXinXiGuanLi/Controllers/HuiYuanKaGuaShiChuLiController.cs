...
{
    public class HuiYuanKaGuaShiChuLiController : Controller
    {
        // GET: HuiYuanKaXinXiGuanLi/HuiYuanKaGuaShiChuLi
        Models.DaXingShangMaoXiTongEntities MyModels = new Models.DaXingShangMaoXiTongEntities();
        public ActionResult HuiYuanKaGuaShiChuLi()
        {
            return View();
        }
        #region 下拉框
        ...
        public ActionResult BtnInser()//保存
        {
            ...
            if (Delst.JiLuBianHao != null && Delst.YuanKaHao != null && Delst.HuiYuanXinMing != null && Delst.UXsable != null && Delst.Amount != null && Delst.ZhaiYao != null)
            {
